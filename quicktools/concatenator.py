...
def zoomed_url(oldurl):
    ...
    new_url = new_url.replace("level=3;degree=0",
      "level=0&rotated=0&x=2312&y=1832&width=4600&height=3700")
...
4371, 4381, 5984, 4379, 5944, 5935, 5989, 5920, 5921, 2606, 7720, 4784, 6341, 
4091, 4336, 5925, 4072, 6344, 4328, 4372, 2592, 4329, 6620, 4330, 4380, 6346,
4369, 5936, 4333, 4089, 5976, 4073, 4335, 6347, 2586, 2609, 5983, 4782, 4781, 5931, 2608, 4783, 4093, 2591, 2720, 4373, 4374, 4375, 4376, 6340, 5932, 4074, 5934, 4131, 5986, 6147, 4327, 5937, 2614, 4331, 4332, 4378, 4785, 5945, 2741, 4334]
...
for ix, doc_id in enumerate(ids):
    ...
    for i in range(1, 9999):
        ...
        if img_match:
            ...
            thunk = download_image(img_url, doc_id, i)
            func = pool.submit(thunk)
